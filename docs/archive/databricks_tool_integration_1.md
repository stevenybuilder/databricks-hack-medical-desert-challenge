...
_Date: 2026-06-15 · Scope: implement `docs/archive/databricks_tools_architecture.md` — connect the local CareGap app to a governed Databricks stack (Unity Catalog medallion, Feature Engineering, MLflow, gold tables, DABs, Jobs, Databricks App)._
