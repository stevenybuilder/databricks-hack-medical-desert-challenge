...
Detailed writeups: `docs/archive/cleaned_dataset_actions.md`, `docs/archive/tricky_fields.md`, `docs/archive/stats_iteration_1.md`, `docs/archive/Bayesian_stats_product_strategy.md`, `docs/STATISTICAL_DECISION_FRAMEWORK.md`.
